...
import getExpert from '../../components/RandomScrolls/RandomTrainer'; // Import the function to get a random photo
    ...
    <>
      ...
      <div className="w-full h-auto flex items-center justify-center flex-col
        lg:py-16 md:py-14 sm:py-12 py-10 lg:px-24 md:px-16 sm:px-6 px-4">
              ...
              <div className="w-full h-auto flex items-center justify-center lg:gap-x-8 md:gap-x-6 sm:gap-x-4 gap-x-3
               lg:gap-y-8 md:gap-y-6 sm:gap-y-4 gap-y-3 flex-wrap mb-10">
                  {/*Let's design it throught loop */}
                  {trainerData.map((data)=> (
                     <div  key={data.id}
                      className="lg:w-[22%]  md:w-[48%] sm:w-[48%] w-full lg:=h-[50vh] md:h-[53vh]
